        ...
        <div class="min-h-[700px] flex items-center justify-center">
          <div class="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form @submit.prevent="handleRegister">
              <div class="mb-4">
                <input type="text" id="username" v-model="username" class="input-modern" placeholder="请输入用户名" autocomplete="username" required />
              </div>
              <div class="mb-4">
                <input type="email" id="email" v-model="email" class="input-modern" placeholder="请输入邮箱" autocomplete="email" required />
              </div>
              ...
              <div class="mb-6">
                <input type="password" id="password" v-model="password" class="input-modern" placeholder="请输入密码" autocomplete="new-password" required />
              </div>
