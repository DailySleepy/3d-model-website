  ...
  <div class="flex w-full max-w-[1600px] min-w-[1000px]">
    <div class="w-3/4">
      ...
      <div class="relative">
        ...
        <ModelViewer v-if="isRendering" :model-url="model.fileUrl" class="w-full aspect-[16/9] border rounded" />
        <img v-else :src="model.thumbnailUrl" alt="thumbnail" class="w-full aspect-[16/9] object-cover rounded" />
      </div>
    ...
    <div class="w-1/4 ml-4 flex flex-col gap-4">
      <!-- 作者信息 -->
