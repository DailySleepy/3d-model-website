<template>
  <div class="flex min-h-screen bg-gray-100 p-4">
  ...
  <div class="w-3/5">
    ...
    <div class="relative">
      ...
      <ModelViewer v-if="isRendering" :model-url="model.fileUrl" class="w-full h-96 border rounded" />
      <img v-else :src="model.thumbnailUrl" alt="thumbnail" class="w-full h-96 object-cover rounded" />
    </div>
  ...
  <div class="w-2/5 ml-4 flex flex-col gap-4">
    <!-- 作者信息 -->
    ...
    <div class="bg-white p-4 rounded shadow">
      ...
      <div class="grid grid-cols-2 gap-2">
        <div v-for="other in model.author.otherModels || []" :key="other.id">
          <img :src="other.thumbnailUrl" class="w-full h-24 object-cover rounded" />
